...
static uint8_t const matrixFnZq[2][8][12][3] =
{
    ...
    {{KEY_LEFTSHIFT}, {00}, {KEY_CAPS_LOCK}, {KEY_SPACEBAR}, {KEY_DELETE}, {KEY_LEFTCONTROL}, {00}, {00}, {KEY_FN}, {KEY_LEFTALT}, {KEY_RIGHTALT}, {KEY_RIGHTSHIFT}}
    },
    ...
    {{00}, {00}, {KEY_CAPS_LOCK}, {KEY_SPACEBAR}, {KEY_DELETE}, {KEY_LEFTCONTROL}, {00}, {00}, {00}, {KEY_LEFTALT}, {KEY_RIGHTALT}, {00}}
    },
};
