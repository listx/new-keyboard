...
static uint8_t const matrixFnZq[2][8][12][3] =
{
    ...
    {{KEY_LEFTSHIFT, KEY_SLASH}, {KEY_7}, {KEY_8}, {KEY_9}, {KEY_EQUAL}, {0}, {0}, {KEY_GRAVE_ACCENT}, {KEY_BACKSLASH}, {KEY_LEFTSHIFT, KEY_MINUS}, {KEY_LEFTSHIFT, KEY_SEMICOLON}, {KEY_LEFTSHIFT, KEY_7}},
    ...
    {{KEY_LEFTSHIFT}, {KEY_INSERT}, {KEY_LEFT_GUI}, {KEY_SPACEBAR}, {KEY_CAPS_LOCK}, {KEY_LEFTCONTROL}, {00}, {00}, {KEY_FN}, {KEY_LEFTALT}, {KEY_RIGHTALT}, {KEY_RIGHTSHIFT}}
    },
