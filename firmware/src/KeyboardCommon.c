...
static uint8_t const matrixFnZq[2][8][12][3] =
{
    ...
    {{KEY_0}, {KEY_4}, {KEY_5}, {KEY_6}, {00}, {KEY_END}, {KEY_HOME}, {KEY_MINUS}, {KEY_LEFTSHIFT, KEY_LEFT_BRACKET}, {KEY_LEFTSHIFT, KEY_9}, {KEY_LEFTSHIFT, KEY_0}, {KEY_LEFTSHIFT, KEY_RIGHT_BRACKET}},
