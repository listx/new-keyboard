...
static uint8_t const matrixFnZq[2][8][12][3] =
{
    ...
    {{KEY_RIGHT_BRACKET}, {KEY_F1}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {KEY_VOLUME_UP}, {KEY_F3}},
    {{KEY_LEFTCONTROL, KEY_LEFTSHIFT, KEY_Z}, {00}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {00}, {KEY_PRINTSCREEN}},
    {{00}, {00}, {KEY_LEFTSHIFT, KEY_INSERT}, {00}, {00}, {0}, {0}, {00}, {00}, {KEY_LEFT_GUI, KEY_X}, {00}, {KEY_ENTER}},
    {{00}, {KEY_7}, {KEY_8}, {KEY_9}, {00}, {0}, {0}, {00}, {KEY_LEFT_BRACKET}, {KEY_PERIOD}, {KEY_RIGHT_BRACKET}, {00}},
    {{KEY_LEFTSHIFT, KEY_EQUAL}, {KEY_4}, {KEY_5}, {KEY_6}, {KEY_MINUS}, {KEY_PAGEUP}, {KEY_PAGEDOWN}, {KEY_LEFTSHIFT, KEY_3}, {KEY_LEFTSHIFT, KEY_LEFT_BRACKET}, {KEY_LEFTSHIFT, KEY_9}, {KEY_LEFTSHIFT, KEY_0}, {KEY_LEFTSHIFT, KEY_RIGHT_BRACKET}},
    ...
    {{KEY_LEFTSHIFT}, {00}, {KEY_CAPS_LOCK}, {KEY_BACKSPACE}, {KEY_DELETE}, {KEY_LEFTCONTROL}, {00}, {00}, {KEY_FN}, {KEY_LEFTALT}, {KEY_RIGHTALT}, {KEY_RIGHTSHIFT}}
    },

    /* KEY_FN2 */
    {
    {{00}, {00}, {00}, {00}, {00}, {00}, {00}, {00}, {00}, {00}, {00}, {00}},
    {{00}, {00}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {KEYPAD_NUM_LOCK}, {00}},
