...
static uint8_t const matrixFnZq[2][8][12][3] =
{
    ...
    {{00}, {KEY_7}, {KEY_8}, {KEY_9}, {KEY_LEFTSHIFT, KEY_7}, {0}, {0}, {KEY_GRAVE_ACCENT}, {KEY_LEFT_BRACKET}, {KEY_PERIOD}, {KEY_RIGHT_BRACKET}, {00}},
    ...
    {{KEY_LEFTSHIFT}, {KEY_INSERT}, {KEY_LEFT_GUI}, {KEY_BACKSPACE}, {KEY_CAPS_LOCK}, {KEY_LEFTCONTROL}, {00}, {00}, {KEY_FN}, {KEY_LEFTALT}, {KEY_RIGHTALT}, {KEY_RIGHTSHIFT}}
    },
    ...
    {{KEY_F11}, {KEY_F4}, {KEY_F5}, {KEY_F6}, {00}, {KEY_PRINTSCREEN}, {KEY_SCROLL_LOCK}, {00}, {KEY_LEFTARROW}, {KEY_DOWNARROW}, {KEY_RIGHTARROW}, {00}},
