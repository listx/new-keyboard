...
__EEPROM_DATA(BASE_ZQ, KANA_ROMAJI, OS_PC, 1 /* delay */, 0 /* mod */, LED_DEFAULT, IME_MS, 0 /* mouse */);
...
static uint8_t const matrixFnZq[2][8][12][3] =
{
    ...
    {{KEYPAD_00}, {KEY_4}, {KEY_5}, {KEY_6}, {00}, {KEY_PAGEUP}, {KEY_PAGEDOWN}, {KEY_LEFTSHIFT, KEY_3}, {KEY_LEFTSHIFT, KEY_LEFT_BRACKET}, {KEY_LEFTSHIFT, KEY_9}, {KEY_LEFTSHIFT, KEY_0}, {KEY_LEFTSHIFT, KEY_RIGHT_BRACKET}},
