...
static uint8_t const matrixZq[8][12] =
{
    ...
    00, KEY_F1, 0, 0, 0, 0, 0, 0, 0, 0, KEY_F12, KEY_LANG1,
    ...
    KEY_Q, KEY_J, KEY_K, KEY_P, KEY_Z,                              0, 0,                           KEY_V,      KEY_F, KEY_L, KEY_R, KEY_W,
    KEY_I, KEY_A, KEY_O, KEY_E, KEY_U,                              KEY_HOME, KEY_END,              KEY_D,      KEY_H, KEY_T, KEY_N, KEY_S,
    KEY_Y, KEY_X, KEY_ZQ_DOUBLE_QUOTE, KEY_QUOTE, KEY_SEMICOLON,   KEY_ZQ_COLON, KEY_ZQ_ASTERISK,  KEY_PERIOD,  KEY_B, KEY_G, KEY_C, KEY_M,
