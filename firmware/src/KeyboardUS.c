...
static uint8_t const matrixZq[8][12] =
{
    ...
    00,     KEY_Y, KEY_O, KEY_M, KEY_P,                     0, 0,                       KEY_V, KEY_F, KEY_K, KEY_R, 00,
    KEY_A,  KEY_I, KEY_E, KEY_U, KEY_W,                     KEY_PAGEUP, KEY_PAGEDOWN,   KEY_D, KEY_H, KEY_T, KEY_N, KEY_S,
    KEY_Z,  KEY_X, KEY_Q, KEY_ZQ_DOUBLE_QUOTE, KEY_QUOTE,   KEY_DELETE, KEY_ENTER,      KEY_B, KEY_J, KEY_G, KEY_C, KEY_L,
