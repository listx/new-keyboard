...
static uint8_t const matrixZq[8][12] =
{
    ...
    KEY_Z, KEY_Y, KEY_U, KEY_B, KEY_PERIOD,     0, 0,                           KEY_ZQ_DOUBLE_QUOTE,    KEY_F, KEY_D, KEY_R, KEY_Q,
    KEY_O, KEY_I, KEY_E, KEY_A, KEY_X,          KEY_HOME, KEY_END,              KEY_V,                  KEY_H, KEY_T, KEY_N, KEY_S,
    KEY_P, KEY_G, KEY_J, KEY_K, KEY_SEMICOLON,  KEY_ZQ_COLON, KEY_ZQ_ASTERISK,  KEY_QUOTE,              KEY_M, KEY_C, KEY_L, KEY_W,
