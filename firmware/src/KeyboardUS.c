...
static uint8_t const matrixZq[8][12] =
{
    ...
    KEY_SEMICOLON, KEY_Y, KEY_O, KEY_P, KEY_V,                    0, 0,                       KEY_F, KEY_D, KEY_T, KEY_R, KEY_ZQ_UNDERSCORE,
    KEY_A,         KEY_I, KEY_E, KEY_U, KEY_W,                    KEY_PAGEUP, KEY_PAGEDOWN,   KEY_H, KEY_J, KEY_K, KEY_L, KEY_N,
    KEY_Z,         KEY_X, KEY_Q, KEY_QUOTE, KEY_ZQ_DOUBLE_QUOTE,  KEY_ESCAPE, KEY_DELETE,     KEY_B, KEY_M, KEY_G, KEY_C, KEY_S,
