...
#define KEY_ZQ_MACRO_GT         0xEE
// 0xF0 taken (KEY_LEFT_FN)
// 0xF1 taken (KEY_RIGHT_FN)
// 0xF2 taken (KEY_FN2)
// 0xF3 taken (KEY_DAKUTEN)
// 0xF4 taken (KEY_HANDAKU)
#define KEY_ZQ_COLON            0xF5
#define KEY_ZQ_SOFTTAB2         0xF6
#define KEY_ZQ_MACRO_CAP_E      0xF7
#define KEY_ZQ_HOMEDIR          0xF8
#define KEY_ZQ_MACRO_TILDE      0xF9
#define KEY_ZQ_MACRO_ASTERISK   0xFA
#define KEY_CALC                0xFB
#define KEY_ZQ_MACRO_PIPE       0xFC
#define KEY_ZQ_MACRO_BANG       0xFD
#define KEY_ZQ_MACRO_DQUOTE     0xFE
